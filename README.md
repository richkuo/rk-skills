...
| `github-issue-format` | Reference skill: the required format for creating or editing any GitHub issue (trailing `[C<score>, model, effort]` title suffix, complexity rationale line, complete-body rule). Loaded automatically before an issue is filed or edited. |
