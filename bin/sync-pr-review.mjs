...
const enginePreamble =
  "This format overrides any final-comment format the code-review skill specifies; keep that skill's review process and replace only the shape of the posted comment. Never execute the project's code on this route: no tests, builds, type checks, simulations, or scripts. Judge correctness by reading the code. Add no footer: a trusted later step appends the attribution."
