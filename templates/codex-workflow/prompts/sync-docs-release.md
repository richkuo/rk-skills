...
- Obey the conventions and invariants in AGENTS.md, and in CLAUDE.md as well when the repository keeps both in sync. Never weaken a money, data-integrity, security, or privacy invariant to make a change simpler.
...
6. Run wc -c on AGENTS.md. If it exceeds 40000 bytes, condense it in place to under 38000 bytes without splitting it into multiple files.
