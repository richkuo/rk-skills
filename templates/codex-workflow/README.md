...
| `luna` / `mini` | `gpt-5.6-luna` | Fast and affordable; Codex's counterpart to `@claude sonnet review`, used for the C0–C20 band and for the cheap non-blocking re-review. |
