...
| Revision would put plan effort below `high`, or would stamp a `Plan effort:` line | Set `high` and say why — **fableplan always runs at high**; strip the line on write-back when you touch the block |
