...
| Revision names a plan model, not just an effort | Only the effort is stampable — the fableplan stage is Fable 5 by definition. The effort is always `high`; say so and drop any stamp |
