...
Build the best solution per CLAUDE.md's engineering rules, scoped to the issue. Write tests for the change; for a bug fix, prove the regression test is real (red then green) by running it against the unfixed code first.
