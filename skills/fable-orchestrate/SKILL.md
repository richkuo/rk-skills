...
- For fan-out runs, merge each worker's worktree branch into the task branch yourself and resolve conflicts (you pinned the interfaces; you own the seams).
